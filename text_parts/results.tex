...
\section{Database and GWAS Navigator}
    ...
    \capstart
        ...
        \begin{minipage}{\captionwidth}
            ...
            Exampalry hover effects for features displayed in the \aca{gwas} Navigator. (\textbf{A}) Hover for variants in the manhattan plot. (\textbf{B}) Hover for variant phenotype associations. (\textbf{C}) Hover for cell type specific enhancers in the \ac{abc} model.}
...
\centering
\begin{minipage}{\captionwidth}
    \caption[enriched samples]{\uzlemph{List of all enriched biosamples}}
