...
\UzLThesisSetup{
  Masterarbeit,
  Titel auf Deutsch     = {Identification genetischer Risikovarianten für Atherosklerose via oxidativem Stress Assay in glatten Gefäßmuskelzellen und bioinformatische Ansätze},
...
\newcommand{\PeproTech}{PeproTech\textsuperscript{\copyright}}
\newcommand{\Invitrogen}{Invitrogen\texttrademark~AG}
\newcommand{\NEB}{New England Biolabs GmbH}
\newcommand{\Baker}{J.T.Baker\textsuperscript{\textregistered}}
...
\newcommand{\Gibco}{Gibco\textsuperscript{\textregistered} BRL}
